% ============================================================
%  TEMPLATE SOAL DAN PEMBAHASAN LENGKAP  (satu mata pelajaran per PDF)
%  Cover + Petunjuk Umum dalam satu halaman, lalu soal + pembahasan.
...
% ===================== WARNA =====================
% Ganti sesuai mata pelajaran:
%   Fisika      → RGB{40,90,150}   / bg RGB{232,240,252}
%   Matematika  → RGB{20,110,60}   / bg RGB{228,246,234}
\definecolor{mapelcolor}{RGB}{40,90,150}       % <-- UBAH
\definecolor{mapelbg}{RGB}{232,240,252}        % <-- UBAH
...
\begin{center}
  \fbox{\parbox{0.55\textwidth}{\centering\bfseries\large LEMBAR SOAL DAN PEMBAHASAN}}
\end{center}
\vspace{0.5cm}
...
% ===================================================================
%  SOAL DAN PEMBAHASAN
%  Setiap nomor: kotak soal diikuti langsung kotak pembahasan.
...
\begin{pembox}
\jawaban{(D) Opsi D}
\konsep Tuliskan konsep atau teorema yang digunakan.

Uraian pembahasan langkah demi langkah:
\[
  F = ma
\]
Substitusi nilai yang diketahui menghasilkan jawaban (D).
\end{pembox}
...
\begin{pembox}
\jawaban{(C) Opsi C}
\konsep Tuliskan konsep yang digunakan.

Uraian pembahasan:
\[
  v = v_0 + at
\]
Sehingga diperoleh jawaban (C).
\end{pembox}
...
\begin{pembox}
\jawaban{$3$}
\konsep $\displaystyle\lim_{x\to 0}\frac{\sin ax}{x} = a$.

Karena $a = 3$, diperoleh nilai limit $= 3$.
\end{pembox}

% ... tambahkan pasangan soal + pembox untuk nomor-nomor selanjutnya ...
